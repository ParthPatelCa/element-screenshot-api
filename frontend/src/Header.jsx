        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-slate-900">DOM Screenshot</h1>
                <p className="text-sm text-slate-500">Professional Element Capture</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <a
              ...
              className="inline-flex items-center space-x-2 px-4 py-2 text-sm font-medium text-slate-700 hover:text-slate-900 hover:bg-slate-50 rounded-lg transition-colors"
            >
